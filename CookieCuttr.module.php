<?php
#-------------------------------------------------------------------------
# Module: CookieCuttr - A simple module to simplify the process of including the CookieCuttr jQuery library for compliance with EU cookie laws
# Version: 1.0, Tom Price
#
#-------------------------------------------------------------------------
...
#-------------------------------------------------------------------------
class CookieCuttr extends CMSModule
{
        
        function __construct() {
            parent::__construct();
            
            // Register the module for use as {CookieCuttr} in template
	...
	/*---------------------------------------------------------
	   ...
	   {cms_module module='CookieCuttr' param1=val param2=val...}
	...
	/*---------------------------------------------------------
	  ...
	  ---------------------------------------------------------*/
	function CheckAccess($perm = 'CookieCuttr')
		{
